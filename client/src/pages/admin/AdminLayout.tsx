...
import { LayoutDashboard, BookOpen, Users, TrendingUp, LogOut, PanelLeft, ArrowLeft } from "lucide-react";
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          ...
          <p className="text-sm text-muted-foreground text-center max-w-sm">Admin access requires authentication.</p>
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="flex flex-col items-center gap-6 p-8 max-w-md w-full text-center">
          ...
          <Link href="/"><span className="btn-neon px-6 py-3 inline-flex items-center gap-2"><ArrowLeft className="h-4 w-4" /> Back to Home</span></Link>
        </div>
      </div>
    );
  }
        ...
        <Sidebar collapsible="icon" className="border-r-0" disableTransition={isResizing}>
          <SidebarHeader className="h-16 justify-center">
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              <button onClick={toggleSidebar} className="h-8 w-8 flex items-center justify-center hover:bg-accent rounded-lg transition-colors focus:outline-none shrink-0">
          ...
          <SidebarContent className="gap-0">
            ...
            <div className="mt-auto px-3 py-2">
              <SidebarMenuButton onClick={() => setLocation("/")} tooltip="Back to Site" className="h-10 font-normal text-muted-foreground">
