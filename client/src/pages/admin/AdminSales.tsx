...
export default function AdminSales() {
  ...
  const [form, setForm] = useState({ status: "active", paymentStatus: "paid", refundStatus: "none", adminNote: "" });
